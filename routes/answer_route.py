...
@answer_api_router.post("/api/submit_answer_file/2018/midterm")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code != 200:
                return {"status": "error", "message": "Failed to download the answer file."}
        ...
        if result.inserted_id:
            ...
            return {"status": "error", "message": "Failed to insert the document."}
    except Exception as e:
        return {"status": "error", "message": str(e)}
